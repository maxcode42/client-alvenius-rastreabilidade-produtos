...
import { XIcon, MenuIcon, UserRound, LogOutIcon } from "lucide-react";
...
export default function Header({ title }) {
  ...
  const { itens: itensDefault } = useMenu();
