...
const PATH_URL = "/api/v1/transfer/component";
...
describe("POST '/api/v1/transfer/component'", () => {
  describe("Default user", () => {
    test("With valid session and create registration", async () => {
      const objectComponent = objectDefaultComponent;
